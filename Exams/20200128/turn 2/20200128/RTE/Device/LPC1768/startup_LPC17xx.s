...
binaryExtendedGCD	PROC
				...
				; r1 = y
				EOR r2, r2		; r2 = g
cycle1Ext		AND r3, r0, #1		; get the LSB of x
				LSL r3, #1		; shift to second bit
				AND r4, r1, #1		; get the LSB of y
				ORR r3, r3, r4		; union of results
				CMP r3, #2_00		
...
cycle2			TST r0, #1		; check the first bit
				...
				BNE ABnotEven
					...
					ASR r6, #1	; B=B/2
					B continueAB
ABnotEven		ADD r5, r5, r4		; A=A+v
				ASR r5, #1		; A=A/2
				SUB r6, r6, r3		; B=B-u
				ASR r6, #1		; B=B/2
continueAB		B cycle2
xOddExt			TST r1, #1		; check the fist bit
				BNE yOddExt
				LSR r1, #1		; y/2
				...
				BNE CDnotEven
					...
					ASR r8, #1	; D=D/2
					B continueCD
CDnotEven		ADD r7, r7, r4		; A=A+v
				ASR r7, #1		; A=A/2
				SUB r8, r8, r3		; B=B-u
				ASR r8, #1		; B=B/2
continueCD		B xOddExt
yOddExt			CMP r0, r1
				BLO xLoyExt
				; x>=y
				SUB r0, r0, r1		; x=x-y
				...
				SUB r6, r6, r8
				B continueExt
xLoyExt			SUB r1, r1, r0		; y=y-x
				SUB r7, r7, r5
				SUB r8, r8, r6
continueExt		CMP r0, #0

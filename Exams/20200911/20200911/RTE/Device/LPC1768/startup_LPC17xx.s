...
cycle1			LDRB r3, [r0], #1	; take the i-th char of string1
				...
				LDRSB r4, [r2, r3]	; take the number of occurrences of that char
				ADD r4, #1		; increment the occurences
				STRB r4, [r2, r3]	; store the occurence
				B cycle1
				; now in mySpace there are the occurences of chars
continue1		LDRB r3, [r1], #1	; take the j-th char of string2
				CMP r3, #0		
				BEQ continue2
				LDRSB r4, [r2, r3]	; take the number of occurences of that char
				SUB r4, #1		; decrement the occurrences
				STRB r4, [r2, r3]	; store the result
				B continue1
...
isAnagram		PROC
				...
				MOV r1, #128
cycleAnagram	LDRB r3, [r2], #17	; take the occurence of i-th char
				CMP r3, #0
				BEQ continueAnagram	
